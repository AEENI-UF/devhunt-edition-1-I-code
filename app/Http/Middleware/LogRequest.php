...
class LogRequest{
    public function handle($request, Closure $next, $guard = null){
        session_start();
        $url = "http://".$_SERVER["SERVER_NAME"]."/DevHunt-i-code/public/";

        $urlServeurTo = "http://".$_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"]."/";
        $routeIndex = "http://".$_SERVER["SERVER_NAME"]."/DevHunt-i-code/public/";
        $routeCreation = "http://".$_SERVER["SERVER_NAME"]."/DevHunt-i-code/public/creation-compte/";
        $routeSignIn = "http://".$_SERVER["SERVER_NAME"]."/DevHunt-i-code/public/sign-in/";
        $routeLogin = "http://".$_SERVER["SERVER_NAME"]."/DevHunt-i-code/public/login/";
        $routeConfirm = "http://".$_SERVER["SERVER_NAME"]."/DevHunt-i-code/public/confirmation/";
        $confirm = "http://".$_SERVER["SERVER_NAME"]."/DevHunt-i-code/public/confirm/";
